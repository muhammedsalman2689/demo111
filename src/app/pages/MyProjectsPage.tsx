...
import { Plus, Home, Check, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[980px] mx-auto px-5 md:px-8 py-20">
        <div className="mb-12">
          ...
          <p className="text-[19px] text-[#86868b] leading-[1.47]" style={{ fontFamily: 'var(--font-text)' }}>
          ...
          {projects.map((project) => (
            ...
            >
              <div className="p-8">
                  ...
                  <div className="flex items-center gap-2">
                    {project.synced ? (
                      <div className="flex items-center gap-1.5 text-[#34c759]">
                        ...
                        <span className="text-[14px]" style={{ fontFamily: 'var(--font-text)' }}>
                          Synced
                        </span>
                      </div>
                    ) : (
                ...
                <p className="text-[17px] text-[#86868b] mb-1" style={{ fontFamily: 'var(--font-text)' }}>
