...
const mockElements: Element[] = [
  {
    ...
    name: 'Window',
    elementType: 'Window',
    images: ['https://images.unsplash.com/photo-1513694203232-719a280e022f?w=800', 'https://images.unsplash.com/photo-1452022449339-24b05e829fca?w=800'],
  ...
  },
  {
    ...
    name: 'Door',
    elementType: 'Door',
    images: ['https://images.unsplash.com/photo-1534172228730-31adb885b2e3?w=800'],
  ...
  },
  {
    ...
    name: 'Bathtub',
    elementType: 'Bathtub',
    images: ['https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800', 'https://images.unsplash.com/photo-1620626011761-996317b8d101?w=800'],
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const getProjectRooms = (projectId: string) => rooms.filter((r) => r.projectId === projectId);

  const getRoomElements = (roomId: string) => elements.filter((e) => e.roomId === roomId);
